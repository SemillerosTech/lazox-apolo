...
const FinalCTA: React.FC = () => {
  return (
    <>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2">
              <h3 className="text-xl font-bold mb-4 text-center">UBICACIÓN</h3>
              <p className="mb-6">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">HORARIOS</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <a
                  ...
                  target="_blank"
                  className="bg-[var(--crayolaYellow)] text-[var(--crayolaGreen)] font-bold py-3 px-6 rounded-lg text-center hover:bg-gray-100 transition"
                >
                  CÓMO LLEGAR
                </a>
                <a
                  ...
                  target="_blank"
                  className="bg-[var(--crayolaYellow)]  text-[var(--crayolaGreen)] font-bold py-3 px-6 rounded-lg text-center hover:bg-green-600 transition"
                >
                  ENVIAR WHATSAPP
                </a>
              </div>
      ...
      <div className="bg-green-950 text-white text-center p-3">
        <p>
          Todos los derechos reservados DIDACTI | Powered by
          <Link href={"https://hypernetics.com.mx/"} target="_blank">
            Hypernetics
          </Link>
        </p>
      </div>
